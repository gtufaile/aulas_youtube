...
def buscar_contato_wpp(lista_msg_excel):
    ...
    driver = webdriver.Chrome('C:\\Lives\\Live #015 - Web Scrapping com Whatsapp\\chromedriver.exe')
...
def main():
    ...
    info_excel = pd.read_excel('C:\\Lives\\Live #015 - Web Scrapping com Whatsapp\\Mensagens_Live15.xlsx')
